...
SECRET_KEY = "django-insecure-q+#z=x+s&gz3c=$j871zd*wpg6a6mjfi$s%+()3nct0)3l96+&"
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "chat_site/templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
TIME_ZONE = TIME_ZONE = "America/New_York"  #'UTC'
